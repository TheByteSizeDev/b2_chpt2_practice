...
let sentence = `${beatles.members[1].name} was in The Beatles from ${beatles.history.formed} 
to ${beatles.history.disbanded}. He was born ${beatles.members[1].birth}. He contributed 
...
//   Your task it to use your knowledge of accessing property values and 
//   array indices to output the commit message for the push event with an 
//   id of 8030403992.


githubData.forEach( function(data) {
    if(data.id === "8030403992") {
